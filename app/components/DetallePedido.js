  ...
  render() {
    ...
    return (
      <div className={style.detalle}>
        <h1 className={style.nombre}>{pedido.nombre}</h1>
        ...
        <h5>Hora solicitud: {pedido.fechaSolicitud.toLocaleTimeString()}</h5>
        <h5>Tiempo aproximado preparacion pedido: 25 minutos</h5>
        <h5>Ordenes del pedido:</h5>
